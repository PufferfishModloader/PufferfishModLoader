package dev.cbyrne.pufferfishmodloader.mods.launch.loader;
...
public class TransformingClassLoader extends URLClassLoader {
    ...
    public TransformingClassLoader() {
        ...
        addClassLoadExclusion("dev.cbyrne.pufferfishmodloader.mods.launch.loader."); // otherwise you can't use this class anywhere except the main class
