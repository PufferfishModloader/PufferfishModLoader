...
package me.dreamhopping.pufferfishmodloader.events;
...
public final class EventSubscriber {
    ...
    public EventSubscriber(@NotNull Object instance, @NotNull Method method, @NotNull Priority priority) {
        ...
        try {
            ...
            PufferfishModLoader.INSTANCE.logger.error("Failed to register event handler {}", method);
            e.printStackTrace();
        }
    }
    ...
    private Class<?> createHandler(Method callback) {
        ...
        cw.visit(V1_6, ACC_PUBLIC | ACC_SUPER, desc, null, "java/lang/Object", new String[]{"me/dreamhopping/pufferfishmodloader/events/EventSubscriber$EventHandler"});
